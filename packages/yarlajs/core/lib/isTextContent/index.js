...
export default skrinkSerializer(
    ...
    function (
        ...
        return (function (argc) { return argc ? startsWith(argc.toLowerCase(), httpContent.TEXT) : false; }(isInstanceOf(argc, globalThis.Headers) ? argc.get(httpHeader.CONTENT_TYPE) : argc));
    }
);
